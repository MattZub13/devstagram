            ...
            <div class="container mx-auto flex justify-between items-center">
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        ...
                        <a href="{{route('posts.create')}}" class="flex items-center gap-2 bg-white border p-2 text-gray-600 font-bold text-sm cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
